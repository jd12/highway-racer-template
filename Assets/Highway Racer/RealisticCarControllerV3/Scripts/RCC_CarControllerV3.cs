...
//			handbrakeInput = 1f;
	...
	public void EngineSounds(){
		...
		float volumeLevel = Mathf.Clamp (_gasInput, 0f, engineRunning ? 1f : 0f);
		...
		case RCC_CarControllerV3.AudioType.OneSource:
			...
			engineSoundHighOff.volume = (engineRunning ? 1f : 0f - volumeLevel) * maxEngineSoundVolume;
		...
		case RCC_CarControllerV3.AudioType.TwoSource:
			...
			engineSoundHighOff.volume = highRPM * (engineRunning ? 1f : 0f - volumeLevel);
			engineSoundHighOff.pitch = pitchLevel;
			engineSoundLowOff.volume = lowRPM * (engineRunning ? 1f : 0f - volumeLevel);
		...
		case RCC_CarControllerV3.AudioType.ThreeSource:
			...
			engineSoundHighOff.volume = highRPM * (engineRunning ? 1f : 0f - volumeLevel);
			engineSoundHighOff.pitch = pitchLevel;
			engineSoundMedOff.volume = medRPM * (engineRunning ? 1f : 0f - volumeLevel);
