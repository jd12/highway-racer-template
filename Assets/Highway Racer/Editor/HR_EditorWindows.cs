...
public class HR_EditorWindows : Editor {
	...
	public static void QuickSwitchToDesktop(){
		...
		FileUtil.MoveFileOrDirectory ("Assets/Highway Racer/Not Included~", "Assets/Highway Racer/PostProcessing");
		AssetDatabase.Refresh ();
//		AssetDatabase.RenameAsset ("Assets/PostProcessing~/", "PostProcessing");
	...
	public static void QuickSwitchToMobile(){
		...
		FileUtil.MoveFileOrDirectory ("Assets/Highway Racer/PostProcessing", "Assets/Highway Racer/Not Included~");
		AssetDatabase.Refresh ();
